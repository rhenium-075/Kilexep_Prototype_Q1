    ...
    <div className="min-h-screen relative">
      ...
      <section className="relative">
        ...
        <div className="relative">
          ...
          >
            <defs>
              {/* Pitch.com exact gradient - subtle radial gradient with purple variations */}
              <radialGradient id="pitchGradient" cx="50%" cy="30%" r="120%">
                <stop offset="0%" style={{stopColor: '#8B5CF6', stopOpacity: 1}} />
                <stop offset="30%" style={{stopColor: '#7C3AED', stopOpacity: 1}} />
                <stop offset="60%" style={{stopColor: '#6D28D9', stopOpacity: 1}} />
              ...
              <linearGradient id="boundaryShadowGradient" x1="0%" y1="70%" x2="0%" y2="100%">
                <stop offset="0%" style={{stopColor: '#6C38CC', stopOpacity: 0}} />
                <stop offset="25%" style={{stopColor: '#7A45D1', stopOpacity: 0.3}} />
                <stop offset="50%" style={{stopColor: '#8B5BE0', stopOpacity: 0.6}} />
                <stop offset="75%" style={{stopColor: '#A378F0', stopOpacity: 0.4}} />
                <stop offset="100%" style={{stopColor: '#C09BF7', stopOpacity: 0.2}} />
              </linearGradient>
            </defs>

            {/* Pitch.com style radial gradient background with U-shaped bottom */}
            <path
          ...
          <div
            ...
            style={{
              background: `linear-gradient(to bottom, transparent 65%, rgba(108, 56, 204, 0.4) 75%, rgba(122, 69, 209, 0.35) 80%, rgba(139, 91, 224, 0.3) 85%, rgba(163, 120, 240, 0.25) 90%, rgba(192, 155, 247, 0.15) 95%, transparent 100%)`
            }}
          >
          </div>
          ...
          <div className="relative z-20 flex flex-col items-center justify-center px-6 pt-32 pb-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <button className="bg-white text-purple-700 hover:bg-purple-50 px-8 py-4 text-lg font-semibold rounded-lg transition-colors">
                  Sign up for free
                </button>
          ...
          <div
            className="relative z-30 px-6 mb-20"
          >
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="bg-gray-100 px-6 py-4 flex items-center border-b">
                ...
                <div className="flex h-full">
                  ...
                  <div className="w-32 bg-gray-50 border-r p-4">
